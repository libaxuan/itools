...
<template>
  <div class="about-page">
    ...
    <n-p>
      ...
      <c-link href="https://github.com/libaxuan" target="_blank" rel="noopener"> Corentin Thomasset </c-link>,
    ...
    <n-p>
      ...
      <c-link href="https://github.com/libaxuan/itools/blob/main/package.json" rel="noopener" target="_blank">
        package.json
      </c-link>
    ...
    <n-p>
      ...
      <c-link
        href="https://github.com/libaxuan/itools/issues/new?assignees=libaxuan&labels=enhancement&template=feature_request.md&title=%5BFEAT%5D%20My%20feature"
        rel="noopener"
        target="_blank"
      >
        issues section
    ...
    <n-p>
      ...
      <c-link
        href="https://github.com/libaxuan/itools/issues/new?assignees=libaxuan&labels=bug&template=bug_report.md&title=%5BBUG%5D%20My%20bug"
        rel="noopener"
        target="_blank"
      >
        issues section
